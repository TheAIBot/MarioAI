...
public class TestEnemyCollisionJumpingRight {
	@Test
	...
	private void checkCollisionBoxForEnemy(EnemyType enemyType, boolean makeCopy) {
		...
		for (int xDistance = 1; xDistance < 4; xDistance++) {
			for (int jumpHeight = 1; jumpHeight < 4; jumpHeight++) {
				...
				TestEnemyHelper.testPathRight(observation, agent, world, marioControls, enemyPredictor, path, enemyType, xDistance, makeCopy);
			}
		}
	}
}
