 ...
 *
 */
public class TestEnemyCollisionRunningRight {
	@Test
	...
	private void checkCollisionBoxForEnemy(EnemyType enemyType, boolean makeCopy) {
		...
		for (int xDistance = 1; xDistance < 4; xDistance++) {
			...
			TestEnemyHelper.testPathRight(observation, agent, world, marioControls, enemyPredictor, pathRight, enemyType, xDistance, makeCopy);
		}
	}
}
